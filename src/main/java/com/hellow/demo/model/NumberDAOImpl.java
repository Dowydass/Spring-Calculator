...
import com.hellow.demo.config.JPAUtil;
...
public class NumberDAOImpl implements NumberDAO{
    ...
    public void updateEntity(Number number){
        ...
        number1.setSk1(number.getSk1());
        number1.setSk2(number.getSk2());
        number1.setRezult(number.getRezult());
        number1.setZenklas(number.getZenklas());

...
public class Number {
    ...
    @Min(value = 0, message = "Validacijos klaida: skaičius negali buti neigiamas")
    @Column(name = "sk1")
    private int sk1;
    ...
    public Number(int sk1, int sk2, String zenklas, int result) {
        this.sk1 = sk1;
        this.sk2 = sk2;
        this.zenklas = zenklas;
        this.result = result;
    }
    public Number(int id, int sk1, int sk2, String zenklas, int result) {
        this.id = id;
        this.sk1 = sk1;
        this.sk2 = sk2;
        this.zenklas = zenklas;
    ...
    // BUTINAS, kad Model vaiksciotu tarp front-end ir back-end

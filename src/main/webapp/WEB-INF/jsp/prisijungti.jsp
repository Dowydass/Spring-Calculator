    ...
    <h1 class="text-center">Internetinis skaiciuotuvas</h1>
        <div class="container">
            <form method="POST" action="${contextPath}/prisijungti" class="form-signin">
                ...
                <span>${message}</span>
                    <input name="username" type="text" class="form-control" placeholder="Prisijungimo vardas" autofocus="true"/>
                    <input name="password" type="password" class="form-control" placeholder="Slaptazodis">
                    <span>${error}</span>
                    <!--
                     Web aplikacija naudotojui turetu isduoti papildoma parametra kuris nebutu nuspejimas piktavaliui.
                     paprastai naudotojui yra isduodamas unikalus CSRF zetonas (token), kuris turi buti validuojamas back-end'e
                     su kiekviena duomenis keiciancia uzklausa.
                    -->
